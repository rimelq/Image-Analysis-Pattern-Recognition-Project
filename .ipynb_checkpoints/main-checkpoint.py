...
def parse_args():
    ...
    p.add_argument("--conf_thresh_score", type=float, default=0.60)  # training confidence threshold
    p.add_argument("--conf_thresh_vis",   type=float, default=0.50)  # output sample visualizations confidence threshold
    ...
    p.add_argument("--conf_thresh", type=float, default=0.50)   # inference confidence threshold
